...
def test_simple(with_pint):
    _check_simple(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_simple_newlines(with_pint):
    _check_simple_newlines(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_simple_encoded(with_pint):
    _check_simple_encoded(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_simple_json_str(with_pint):
    _check_simple_json_str(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_wc1382_unicode_str(with_pint):
    _check_wc1382_unicode_str(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_unsupported_old(with_pint):
    _check_unsupported_old(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_unsupported_newer(with_pint):
    _check_unsupported_newer(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_oddball_version(with_pint):
    _check_oddball_version(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_unsupported_bleedingedge(with_pint):
    _check_unsupported_bleedingedge(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_malformed_grid(with_pint):
    _check_malformed_grid(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_malformed_version(with_pint):
    _check_malformed_version(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_metadata(with_pint):
    _check_metadata(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_metadata_json(with_pint):
    _check_metadata_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_null(with_pint):
    _check_null(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_null_json(with_pint):
    _check_null_json(with_pint)
...
def check_na(grid):
    assert len(grid) == 1
    assert grid[0]['na'] is hszinc.NA


@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_na(with_pint):
    _check_na(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_na_json(with_pint):
    _check_na_json(with_pint)
...
def check_remove(grid):
    assert len(grid) == 2
    assert grid[0]['remove'] is hszinc.REMOVE
    assert grid[1]['remove'] is hszinc.REMOVE


@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_remove(with_pint):
    _check_remove(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_remove_json_v2(with_pint):
    _check_remove_json_v2(with_pint)


@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_remove_json_v3(with_pint):
    _check_remove_json_v3(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_marker_in_row(with_pint):
    _check_marker_in_row(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_marker_in_row_json(with_pint):
    _check_marker_in_row_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_bool(with_pint):
    _check_bool(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_bool_json(with_pint):
    _check_bool_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_number(with_pint):
    _check_number(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_number_json(with_pint):
    _check_number_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_string(with_pint):
    _check_string(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_string_json(with_pint):
    _check_string_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_uri(with_pint):
    _check_uri(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_uri_json(with_pint):
    _check_uri_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_ref(with_pint):
    _check_ref(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_ref_json(with_pint):
    _check_ref_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_date(with_pint):
    _check_date(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_date_json(with_pint):
    _check_date_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_time(with_pint):
    _check_time(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_time_json(with_pint):
    _check_time_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_datetime(with_pint):
    _check_datetime(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_datetime_json(with_pint):
    _check_datetime_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_list(with_pint):
    _check_list(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_list_v2(with_pint):
    _check_list_v2(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_list_json(with_pint):
    _check_list_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_list_json_v2(with_pint):
    _check_list_json_v2(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_bin(with_pint):
    _check_bin(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_bin_json(with_pint):
    _check_bin_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_coord(with_pint):
    _check_coord(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_coord_json(with_pint):
    _check_coord_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_multi_grid(with_pint):
    _check_multi_grid(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_multi_grid_json(with_pint):
    _check_multi_grid_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_multi_grid_json_str(with_pint):
    _check_multi_grid_json_str(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_grid_meta(with_pint):
    _check_grid_meta(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_col_meta(with_pint):
    _check_col_meta(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_too_many_cells(with_pint):
    _check_too_many_cells(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_nodehaystack_01(with_pint):
    _check_nodehaystack_01(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_nodehaystack_02(with_pint):
    _check_nodehaystack_02(with_pint)
...
''', single=True)
    ...
    assert grid.metadata['tag'] is hszinc.MARKER
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_nodehaystack_03(with_pint):
    _check_nodehaystack_03(with_pint)
...
''', single=True)
    ...
    assert grid[0]['val'] is None


@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_nodehaystack_04(with_pint):
    _check_nodehaystack_04(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_nodehaystack_05(with_pint):
    _check_nodehaystack_05(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_nodehaystack_06(with_pint):
    _check_nodehaystack_06(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_nodehaystack_07(with_pint):
    _check_nodehaystack_07(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_nodehaystack_08(with_pint):
    _check_nodehaystack_08(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_nodehaystack_09(with_pint):
    _check_nodehaystack_09(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_nodehaystack_10(with_pint):
    _check_nodehaystack_10(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_nodehaystack_11(with_pint):
    _check_nodehaystack_11(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_scalar_simple_zinc(with_pint):
    _check_scalar_simple_zinc(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_scalar_bytestring_zinc(with_pint):
    _check_scalar_bytestring_zinc(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_scalar_version_zinc(with_pint):
    _check_scalar_version_zinc(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_scalar_simple_json(with_pint):
    _check_scalar_simple_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_scalar_preparsed_json(with_pint):
    _check_scalar_preparsed_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_scalar_bytestring_json(with_pint):
    _check_scalar_bytestring_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_scalar_version_json(with_pint):
    _check_scalar_version_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_scalar_json_rawnum(with_pint):
    _check_scalar_json_rawnum(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_str_version(with_pint):
    _check_str_version(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_malformed_grid_meta(with_pint):
    _check_malformed_grid_meta(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_malformed_col_meta(with_pint):
    _check_malformed_col_meta(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_malformed_row(with_pint):
    _check_malformed_row(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_grid_in_grid(with_pint):
    _check_grid_in_grid(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_grid_in_grid_json(with_pint):
    _check_grid_in_grid_json(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_grid_in_grid_in_grid(with_pint):
    _check_grid_in_grid_in_grid(with_pint)
...
@pytest.mark.parametrize("with_pint", [(False,), (True,)])
def test_grid_in_grid_in_grid_json(with_pint):
    _check_grid_in_grid_in_grid_json(with_pint)
